  ...
  const plans = [
    {
      ...
      price: 'R$ 17,90',
      period: 'por mês',
      link: 'https://pay.kiwify.com.br/UEynL19',
      description: 'Controle total das suas finanças mensais'
    },
    {
      id: 'yearly',
      name: 'Plano Anual',
      price: 'R$ 67,00',
      period: 'por ano',
      link: 'https://pay.kiwify.com.br/PHUjeqo',
      description: 'Economia de 70% - Melhor custo-benefício',
      popular: true
    }
  ];
  
  const handleSubscribe = (planLink: string) => {
    console.log('Iniciando processo de pagamento - Controle no Zap');
  ...
  return (
    <div className="min-h-screen flex bg-background p-4 sm:p-6">
        ...
        <div className="absolute bottom-8 left-8 text-white">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
            <p className="text-sm font-medium mb-3">
              Mais de 500 usuários já usam o ZapControla
            </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative">
        ...
        <div className="w-full max-w-4xl mt-4 sm:mt-8 lg:mt-16 space-y-4">
          <div className="flex justify-center">
            <BrandLogo className="h-52 sm:h-60 lg:h-68 w-auto" />
          </div>
          
          <div className="w-full mx-auto">
            <div className="text-center py-4 sm:py-6 lg:py-8">
              <h1 className="text-2xl sm:text-3xl font-bold text-slate-800 mb-2 dark:text-slate-300">
                Escolha seu plano
              </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                {plans.map((plan) => (
                  <div 
                    key={plan.id}
                    className={`relative bg-white dark:bg-gray-800 rounded-2xl p-6 border-2 transition-all duration-300 hover:shadow-lg ${
                      plan.popular 
              ...
              <div className="bg-primary/10 rounded-lg p-4 mb-6">
                <p className="text-base font-semibold text-primary text-center">
                  Invista no controle da sua vida financeira! 
                  <br />
                  <span className="text-sm">Plano anual: menos de R$0,18 por dia</span>
                </p>
              </div>
              ...
              <Button 
                ...
                className="w-full md:w-auto h-11 border-primary text-primary hover:bg-primary hover:text-primary-foreground text-base"
              >
                Voltar ao login
              </Button>
            </div>
